...
<p  data-aos="fade-left"  className="flex f gap-3 items-center text-3xl  lg:text-6xl font-bold justify-center"><img src={about} alt="" className="lg:w-40 w-20 " /> ABOUT</p>
